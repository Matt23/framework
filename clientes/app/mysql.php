...
class mysql {
	...
	public function __construct($host=DB_HOSTNAME, $usr=DB_USERNAME, $pwd=DB_PASSWORD, $dbname=DB_NAME, $dbport=DB_PORT) {

		try {
			$this->db = new PDO('mysql:host=' . $host . ';port=' . $dbport . ';dbname=' . $dbname, $usr, $pwd);
