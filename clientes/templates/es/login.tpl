...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="{tplFolder}plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
    ...
    <div class="card-body login-card-body">
      ...
      <form action="{path}users/login" method="post">
        <div class="input-group mb-3">
          <input name="email" type="email" class="form-control" value="{emailpost}" placeholder="Email">
...
<!-- AdminLTE App -->
<script src="{tplFolder}dist/js/adminlte.min.js"></script>
</body>
</html>
