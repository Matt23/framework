  ...
  <div class="content-wrapper">
    ...
    <div class="card card-primary" style="{styleDisplayNone}">
      <div class="card-header">
        <h3 class="card-title">Modifique los datos del cliente.</h3>
      </div>
      <!-- /.card-header -->
      <!-- form start -->
      <form method="post" action="{path}clientes/editar/{id}">
        <div class="card-body">
    ...
    <div class="card-footer">
      <button type="submit" class="btn btn-primary" style="float:right;">Actualizar Informaci&oacute;n</button>
      </form>
